...
microbe_log2_read_df = np.log2(read_df.loc[snakemake.wildcards["microbe"]]+1)
microbe_log2_read_df.columns = [snakemake.wildcards["microbe"]]
...
ax.set(ylabel="log2({} reads+1)".format(snakemake.wildcards["microbe"]))
