...
MICROBE_READ_SWARMPLOT = join("output", "{tax_level}-{method}-{microbe}_microbe_reads-{celltype}-swarmplot.png")
...
rule swarmplot_reads_across_celltypes:
    input:
        MICROBE_READ_TABLE,
        SAMPLE_METADATA
    output:
