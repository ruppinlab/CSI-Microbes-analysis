...
for _, sample in samples.iterrows():
    ...
    print(df.sort_values(by="read_count", ascending=False).iloc[0:20])
...
feature_df = pd.read_csv("data/GCF_013343155.1_ASM1334315v1_feature_table.txt", sep="\t")
...
gene_level_df.groupby(["sample", "class"])["read_count"].sum()
