...
Myeloid.Capnocytophaga <- get.positive.percent(sce, "Myeloid", "Capnocytophaga")
Tcell.Capnocytophaga <- get.positive.percent(sce, "TNKILC", "Capnocytophaga")
Bcell.Capnocytophaga <- get.positive.percent(sce, "B", "Capnocytophaga")
Epithelial.Capnocytophaga <- get.positive.percent(sce, "Epithelial", "Capnocytophaga")
Stromal.Capnocytophaga <- get.positive.percent(sce, "Stromal", "Capnocytophaga")


condition <- c(rep("Capnocytophaga", 5))
celltype <- c(rep(c("Myeloid", "TNKILC", "B", "Tumor", "Stromal"), 3))
positive.percent <- c(Myeloid.Capnocytophaga, Tcell.Capnocytophaga, Bcell.Capnocytophaga, Epithelial.Capnocytophaga, Stromal.Capnocytophaga)

df <- data.frame(condition, celltype, positive.percent)

df$condition <- factor(df$condition, levels=c("Capnocytophaga"))
