...
from scipy.stats import fisher_exact, combine_pvalues, chisquare
...
print(snakemake.wildcards["cutoff"])
...
granulocytes_pvalues = calculate_celltype_pvalues(df, "celltype2", "Granulocyte")
...
pvalues_df = pd.DataFrame({"pvalue": [DC_pvalues, granulocytes_pvalues, macrophage_pvalues, monocyte_pvalues, mast_pvalues], "celltype2": ["DC", "Granulocyte", "Macrophage", "Monocyte", "Mast"]})
